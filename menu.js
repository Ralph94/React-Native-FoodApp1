...
const MenuPage = ({ navigation }) => {
  const renderCategoryItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity onPress={() => navigation.navigate("categoryPizzas")}>
        <View
        style={[
          styles.categoryItemWrapper,
          {
            backgroundColor: item.selected1 ? colors.yellow : colors.cripsyWhite,
    ...
    <View style={styles.container}>
      <ScrollView
        ...
        <View style={styles.categoriesWrapper}>
          <Text style={styles.categoriesTitle}>Categories Taco</Text>
        ...
        <View style={styles.popularWrapper}> 
          ...
          {popularData.map((item) => (  //map function to render popularData from popularData.js file 
            <TouchableOpacity
