...
const categoryPizzas = ({ navigation }) => {
  const renderCategoryItem = ({ item }) => {
    return (
      <TouchableOpacity onPress={() => navigation.navigate("categorySodas")}>
      <View
        style={[
          styles.categoryItemWrapper,
          {
            backgroundColor: item.selected2 ? colors.yellow : colors.cripsyWhite,
    ...
    <View style={styles.container}>
      <ScrollView
        ...
        <View style={styles.categoriesWrapper}>
          <Text style={styles.categoriesTitle}>Categories Pizza</Text>
        ...
        <View style={styles.popularWrapper}> 
          ...
          {pizzaSection.map((item) => (  //map function to render popularData from popularData.js file 
            <TouchableOpacity
