...
import cheeseburgerData from './assets/data/cheeseburgerData';


const categoryCheeseburger = ({ navigation }) => {
    ...
    return (
      ...
      <View
        style={[
          ...
          {
            backgroundColor: item.selected4 ? colors.yellow : colors.cripsyWhite,
    ...
    <View style={styles.container}>
      <ScrollView
        ...
        <View style={styles.categoriesWrapper}>
          <Text style={styles.categoriesTitle}>Categories Cheeseburgers</Text>
        ...
        <View style={styles.popularWrapper}> 
          ...
          {cheeseburgerData.map((item) => (  //map function to render popularData from popularData.js file and we are mapping it to the item
            <TouchableOpacity
              key={item.id} // key is required for FlatList to work properly in order to render the data properly
              onPress={() =>
                navigation.navigate('Details', {
                  item: item, // this is the item that we are passing to the Details page so we can access it in the Details page
                })
              }>
              <View
                style={[
...
export default categoryCheeseburger;
